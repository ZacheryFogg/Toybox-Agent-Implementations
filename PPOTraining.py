...
class SaveOnBestTrainingRewardCallback(BaseCallback):
    ...
    def _init_callback(self) -> None:
        ...
        if self.save_path is not None:
            ...
            os.makedirs('./output/PPO/checkpoint_models/')
    def _on_step(self) -> bool:
        if self.n_calls % self.check_freq == 0:
          model.save('./output/PPO/checkpoint_models/ppo_chkpnt_model_{}.pkl'.format(self.num_timesteps))
...
model.save('./output/PPO/models/ppo_final_model.pkl')
